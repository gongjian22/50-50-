...
const animated_bg_texts = document.querySelectorAll('.animate-bg-text')
...
function getData () {
  ...
  excerpt.innerHTML = `Lorem ipsum dolor sit amet consectetur adipisicing elit. Solore perferendis`
